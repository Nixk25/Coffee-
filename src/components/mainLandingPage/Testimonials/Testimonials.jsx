        ...
        <div className="testimonials-container">
          <div className="profile">
            <img
              ...
              alt="man with beautiful hat"
            />
            <span className="text">I really love this coffee!</span>
          </div>
          <div className="profile">
            <img
              ...
              alt="woman with the glasses on"
            />
            <span className="text">This coffee shop is great!</span>
          </div>

          <div className="profile">
            <img src={firstTestimonials} alt="woman with blonde hair" />
            <span className="text">The coffee menu is just amazing</span>
          </div>
        </div>
      </div>
    </section>
